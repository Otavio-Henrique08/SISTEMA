 <ul class="menu">
          ...
          <li> <a href="listaVenda.php" class="menu-item"> <i class="fa-solid fa-magnifying-glass-dollar"></i> Pesquisar Vendas </a> </li>
          <li> <a href="grafico.php" class="menu-item"> <i class="fa-solid fa-chart-simple"></i> Gráficos </a> </li>
        </ul> 